...
async def test_fake_provider():
    ...
    try:
        ...
        raise AssertionError("Should have raised SymbolNotFoundError")
...
async def test_yahoo_provider():
    ...
    try:
        ...
        print("  [INFO] This may be due to network issues or rate limiting")
    ...
    try:
        ...
        print("  [OK] Invalid symbol rejected")
    except Exception as e:
...
async def test_provider_swapping():
    ...
    print("  [OK] Provider swapping works via DI")
