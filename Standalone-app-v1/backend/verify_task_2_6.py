...
async def test_composite_primary_key():
    ...
    try:
        ...
        if pk_columns == expected_pk:
            print(f"  [PASS] Composite primary key correctly set on (ticker_id, date)")
        else:
        ...
        if not ticker_id_col.nullable and not date_col.nullable:
            ...
            print(f"  [FAIL] PK columns nullable status incorrect")
            return False
...
async def test_decimal_types():
    ...
    try:
        ...
        if isinstance(quality_score_col.type, DECIMAL):
            print(f"  [PASS] Column 'quality_score' uses DECIMAL type")
        else:
            print(f"  [FAIL] Column 'quality_score' should use DECIMAL")
            return False
...
async def test_data_lineage_fields():
    ...
    try:
        ...
        if data_source_col is not None and not data_source_col.nullable:
            ...
            print(f"  [FAIL] 'data_source' configuration incorrect")
            return False
        ...
        if ingested_at_col is not None and not ingested_at_col.nullable:
            ...
            print(f"  [FAIL] 'ingested_at' configuration incorrect")
            return False
        ...
        if hasattr(ingested_at_col.type, 'timezone') and ingested_at_col.type.timezone:
            ...
            print(f"  [FAIL] 'ingested_at' should have timezone")
            return False
        ...
        if quality_score_col is not None:
            ...
            print(f"  [FAIL] 'quality_score' field missing")
            return False
